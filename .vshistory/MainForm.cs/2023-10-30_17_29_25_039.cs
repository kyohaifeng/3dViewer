        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    // Import the OBJ file
                    Scene model = assimpContext.ImportFile(selectedFileName, PostProcessSteps.Triangulate | PostProcessSteps.JoinIdenticalVertices);
                    // Display the file contents or perform other actions
                    MessageBox.Show("File : " + selectedFileName, "File Opened");
                }
            }
        }
