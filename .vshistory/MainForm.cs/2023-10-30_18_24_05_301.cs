...
namespace _3dViewer
{
    public partial class MainForm : Form
    {
        ...
        private Scene ImportModel(string filePath, ProgressDialog progressDialog)
        {
            using (var assimpContext = new AssimpContext())
            {
                Scene model = assimpContext.ImportFile(filePath);

                // Your code to process the model (e.g., setting up rendering or further operations)
                // ...
